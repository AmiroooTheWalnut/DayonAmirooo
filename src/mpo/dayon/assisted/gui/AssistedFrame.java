...
public class AssistedFrame extends BaseFrame {
	public final transient Action startAction;//EDIT BY AMIROOO
	public final transient Action stopAction;//EDIT BY AMIROOO
	public boolean connected;//EDIT BY AMIROOO
